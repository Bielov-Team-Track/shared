...
public class BaseRepository<T> : IRepository<T> where T : class, IEntity<Guid>
{
    ...
    public virtual async Task<bool> ExistsAsync(Guid id) => await _dbSet.AnyAsync(e => e.Id == id);
